...
class Database:
    ...
    def _init_db(self):
        ...
        # Schema-Migration: filter_cycles – events_json und active_seconds
        with self._conn() as conn:
            ...
            if "active_seconds" not in existing:
                conn.execute("ALTER TABLE filter_cycles ADD COLUMN active_seconds REAL DEFAULT NULL")
    ...
    def insert_cycle(self, data: dict) -> int:
        ...
        data.setdefault("active_seconds", None)
        sql = """
